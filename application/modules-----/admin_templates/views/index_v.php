											...
											<div class="widget-main">
												...
												<form >
													<fieldset>
														<label>
															<span class="block input-icon input-icon-right">
																<input type="email" name="reset_password_email" id="reset_password_email" class="span12" placeholder="Email" />
														...
														<div class="clearfix">
															<button onclick="reset_password(); return false;" class="width-35 pull-right btn btn-small btn-danger">
