													...
													<tbody>
														...
														<tr>
															...
															<?php  if($content_gateway[$i]['id'] == "2" ) {  ?>
																...
																<input type="hidden" name="auction_id" id="auction_id" value="<?php echo $this->uri->segment(3);?>">
																<script
																		src="https://checkout.stripe.com/checkout.js" class="stripe-button"
																		data-key="<?php echo $content_gateway[$i]['public_key'] ?>"
																		data-amount="<?php echo (number_format($price, 2,'.',' ') * 100); ?>"
																		data-name="<?php echo $content_invoice[0]['auction_name'];?>"
																		data-description="<?php echo $content_invoice[0]['auction_name'];?>"
																		data-currency="CAD"
																		>
																</script> 
															   	<script>
