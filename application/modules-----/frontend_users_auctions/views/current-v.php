												...
												<table class="table table-bordered table-hover">
													<tbody>
														...
														<tr>
															...
															<td><a href="<?php echo base_url().'product/'.$content_auction[$i]['auction_name'].'/'.$content_auction[$i]['auction_id'];?>.html"><?php echo $content_auction[$i]['auction_name']?></a></td>
