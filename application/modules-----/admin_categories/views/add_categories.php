				...
				<div class="page-content">
					...
					echo form_input(array('id' => 'category_id', 'name' => 'category_id', 'type'=>'hidden', 'value'=>isset($content_list[0]['category_id']) ? $content_list[0]['category_id'] : '')); 

					echo form_input(array('id' => 'type', 'name' => 'type', 'type'=>'hidden', 'value'=>isset($content_list[0]['category_id']) ? 'edit' : 'add')); 
