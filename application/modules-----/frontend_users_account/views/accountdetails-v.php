										...
										<form autocomplete="off" id="account_form" name="account_form" method="post" class="hiraola-form">
                                            ...
                                            <div class="hiraola-form-inner">
                                                ...
                                                <div class="single-input single-input-half">
                                                    ...
                                                    <input type="text" id="address" name="address" value="<?php echo (isset($content_address[0]['address'])) ?  $content_address[0]['address']:''; ?>">
                                                </div>

                                                <div class="single-input single-input-half">
                                                    <label for="account-details-mobile">City*</label>
                                                    <input type="text" id="city" name="city" value="<?php echo (isset($content_address[0]['city'])) ?  $content_address[0]['city']:''; ?>">
                                                </div>

                                                <div class="single-input single-input-half">
                                                    <label for="account-details-mobile">State*</label>
                                                    <input type="text" id="state" name="state" value="<?php echo (isset($content_address[0]['state'])) ?  $content_address[0]['city']:''; ?>">
                                                </div>

                                                <div class="single-input single-input-half">
                                                    <label for="account-details-mobile">Pincode*</label>
                                                    <input type="text" id="pin" name="pin" value="<?php echo (isset($content_address[0]['pin'])) ?  $content_address[0]['pin']:''; ?>">
                                                </div>
