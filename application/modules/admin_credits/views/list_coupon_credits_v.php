								...
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th><?php echo ucwords($configpage[1]);?> Credits</th>
											<th><?php echo ucwords($configpage[1]);?> Validity</th>
											<th class="hidden"></th>
									...
									<tbody>
										...
										<tr id="<?php echo $credit_list[$i]['id'];?>">
											...
											<td>
												<a href="add_coupon_credits/<?php echo $credit_list[$i]['id'];?>.html"><?php echo $this->admin_templates->base_currency($data=NULL).$credit_list[$i]['coupon_rate'];?></a>
											</td>
											<td>
												<a href="add_coupon_credits/<?php echo $credit_list[$i]['id'];?>.html"><?php echo $credit_list[$i]['coupon_credit'];?> Credits</a>
											</td>
											<td><?php echo $credit_list[$i]['coupon_validity'];?> Month</td>
											<td class="hidden"></td>
											...
											<td class="hidden-480">
													...
													<div class="span3">
														...
														<label>
															<input name="status" id="status" class="ace-switch ace-switch-6" type="checkbox" <?php if($credit_list[$i]['active']=='1'){echo 'checked';}?> value="<?php echo $credit_list[$i]['id'].'|user_bidcoupon_rate|id|active';?>"/>
															<span class="lbl"> </span>
														</label>
											...
											<td class="td-actions">
												<div class="hidden-phone visible-desktop action-buttons">
													<a class="green" href="add_coupon_credits/<?php echo $credit_list[$i]['id'];?>.html" title="edit"  data-rel="tooltip" >
