						...
						<div class="span12">
							...
							<div class="row-fluid">
								...
								<div class="table-header">
									Results for "<?php echo ucwords(str_replace('_',' ',$this->router->fetch_method()));?>" <a href="download_users/" style="float:right; margin-right:40px;color:#fff; font-weight:bold;">Download <?php echo ucwords($configpage[1]);?></a>
