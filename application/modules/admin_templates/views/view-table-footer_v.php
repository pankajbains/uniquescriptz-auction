...
<![endif]-->
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='assets/backendfiles/js/jquery-2.0.3.min.js'>"+"<"+"/script>");
		</script>
...
<![endif]-->
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='assets/backendfiles/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
