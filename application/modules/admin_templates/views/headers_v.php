...
<html lang="en">
	<head>
		...
		<!--link rel="stylesheet" href="<?php echo base_url();?>assets/backendfiles/css/jquery-ui-1.10.3.custom.min.css" /-->
		<!--fonts-->
		...
		<link rel="stylesheet" href="<?php echo base_url();?>assets/backendfiles/css/datepicker.css" />
...
<script>
        ...
        //CKEDITOR.config.shiftEnterMode = CKEDITOR.ENTER_BR; //pressing the SHIFT + ENTER KEYS input <p>
					...
					<ul class="nav ace-nav pull-right">
						...
						<li class="green">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
								...
								<li>
									<a href="#">
										<img src="<?php echo base_url();?>assets/backendfiles/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
										<span class="msg-body">
								...
								<li>
									<a href="#">
										<img src="<?php echo base_url();?>assets/backendfiles/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#">
										<img src="<?php echo base_url();?>assets/backendfiles/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?php echo base_url();?>assets/backendfiles/avatars/user.jpg" alt="Jason's Photo" />
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
								...
								<li>
									<a href="<?php echo base_url();?>admin/logout.html">
										<i class="icon-off"></i>
										Logout
									</a>
								</li>
...
<?php
	$this->load->view('admin_templates/leftnav_v');
?>
