<ul>
										...
										?>
											<a name="#" id="start_bids_price"><?php echo $this->frontend_templates->convert_currency_price('currency_price',$content_data[0]['auction_price']); ?></a><a name="#"><?php echo '-'; ?></a><a name="#" id="end_bids_price"><?php echo $this->frontend_templates->convert_currency_price('currency_price',$content_data[0]['auction_price']+$content_data[0]['auction_price']); ?></a> </li>
										<?php } else {  ?>
											<a name="#" id="start_bids_price"> <?php echo $this->frontend_templates->convert_currency_price('currency_price',$content_bidunique_data-$content_data[0]['auction_price']); ?></a><a name="#"><?php echo '-'; ?></a><a name="#" id="end_bids_price"> <?php echo $this->frontend_templates->convert_currency_price('currency_price',$content_bidunique_data+$content_data[0]['auction_price']); ?> </a> </li>
