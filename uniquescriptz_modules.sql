...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_user_register` ()   BEGIN
...
--
-- Table structure for table `admin_config_app`
--

CREATE TABLE `admin_config_app` (
  `id` int(11) NOT NULL,
  `config_type` varchar(60) NOT NULL,
  `site_invoice` int(9) DEFAULT NULL,
  `site_currency` varchar(20) DEFAULT NULL,
  `site_timezone` varchar(60) NOT NULL,
  `site_title` text NOT NULL,
  `site_name` text NOT NULL,
  `site_desc` text NOT NULL,
  `site_header_logo` varchar(60) DEFAULT NULL,
  `site_sticky_header_logo` varchar(60) DEFAULT NULL,
  `site_favicon` varchar(60) DEFAULT NULL,
  `site_analytics` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `admin_config_app`
--
...
--
-- Table structure for table `admin_config_points`
--
...
--
-- Dumping data for table `admin_config_points`
--

INSERT INTO `admin_config_points` (`id`, `config_type`, `points_register`, `points_login`, `point_refer`, `points_fblikes`, `points_fbshare`, `points_tweet`, `points_value`) VALUES
(1, 'user_points', 25, 2, 2, 2, 2, 2, 2);

-- --------------------------------------------------------

--
-- Table structure for table `admin_config_social`
--

CREATE TABLE `admin_config_social` (
  `id` int(11) NOT NULL,
  `config_type` varchar(20) NOT NULL,
  `social_facebook` varchar(60) DEFAULT NULL,
  `social_twitter` varchar(60) DEFAULT NULL,
  `social_gplus` varchar(60) DEFAULT NULL,
  `social_linkedin` varchar(60) DEFAULT NULL,
  `social_instagram` varchar(60) DEFAULT NULL,
  `social_pinterest` varchar(60) DEFAULT NULL,
  `social_youtube` varchar(60) DEFAULT NULL,
  `social_facebook-app-id` varchar(60) DEFAULT NULL,
  `social_facebook-secret` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `admin_config_social`
--

INSERT INTO `admin_config_social` (`id`, `config_type`, `social_facebook`, `social_twitter`, `social_gplus`, `social_linkedin`, `social_instagram`, `social_pinterest`, `social_youtube`, `social_facebook-app-id`, `social_facebook-secret`) VALUES
(1, 'social_media', '', 'uniquescriptz', '', 'uniquescriptz', 'uniquescriptz', 'uniquescriptz', 'uniquescriptx', '', '');
...
CREATE TABLE `admin_users` (
  ...
  `admin_cpassword` varchar(255) DEFAULT NULL,
...
CREATE TABLE `auction_category` (
  ...
  `auction_category` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `auction_features`
--

CREATE TABLE `auction_features` (
  `auct_id` int(10) NOT NULL,
  `auction_id` varchar(15) NOT NULL,
  `featured` tinyint(1) NOT NULL,
  `sretail` tinyint(1) NOT NULL,
  `sallowed_bids` tinyint(1) NOT NULL,
  `sreq_bids` tinyint(1) NOT NULL,
  `stotal_bids` tinyint(1) NOT NULL,
  `sremaining_bids` tinyint(1) NOT NULL,
  `scurrent_bids` tinyint(1) NOT NULL,
  `extend_auction` smallint(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `auction_features`
--
...
(105, 'UNI17-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(18, 'UNI18-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(106, 'UNI18-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(19, 'UNI19-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(107, 'UNI19-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(20, 'UNI20-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(108, 'UNI20-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(21, 'UNI21-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(109, 'UNI21-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(22, 'UNI22-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(110, 'UNI22-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(23, 'UNI23-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(111, 'UNI23-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(24, 'UNI24-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(112, 'UNI24-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(25, 'UNI25-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(113, 'UNI25-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(26, 'UNI26-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(114, 'UNI26-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(27, 'UNI27-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(115, 'UNI27-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(28, 'UNI28-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(116, 'UNI28-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(29, 'UNI29-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(117, 'UNI29-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(30, 'UNI30-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(118, 'UNI30-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(31, 'UNI31-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(119, 'UNI31-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(32, 'UNI32-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(120, 'UNI32-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(33, 'UNI33-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(121, 'UNI33-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(34, 'UNI34-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(122, 'UNI34-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(35, 'UNI35-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(123, 'UNI35-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(36, 'UNI36-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(124, 'UNI36-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(37, 'UNI37-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(125, 'UNI37-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(38, 'UNI38-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(126, 'UNI38-2022', 0, 1, 1, 1, 1, 1, 1, 0),
(39, 'UNI39-2021', 1, 1, 1, 1, 1, 1, 1, 0),
(127, 'UNI39-2022', 0, 1, 1, 1, 1, 1, 1, 0),
...
--
-- Table structure for table `auction_won`
--
...
--
-- Dumping data for table `auction_won`
--
...
INSERT INTO `manage_banner` (`id`, `banner_id`, `banner_name`, `banner_img`, `banner_open`, `created_at`, `updated-at`) VALUES
(1, 'UNI1', 'shoaib', '16616195794667banner_img.jpeg', 0, '2022-08-27 22:29:39', '2022-08-27 22:29:39'),
(2, 'UNI2', 'ddddd', '16616237865062banner_img.jpg', 0, '2022-08-27 23:39:46', '2022-08-27 23:39:46'),
(3, 'UNI3', 'mmm', '16616264671399banner_img.jpg', 1, '2022-08-28 00:24:27', '2022-08-28 00:24:27');
...
(33, 'UNI33', 'Car', 'Automotive', 'car', 1),
(34, 'UNI34', 'Motorcycle', 'Automotive', 'motorcycle', 1),
(35, 'UNI35', 'Wheels & Tires', 'Automotive', 'wheels-tyres', 1),
(36, 'UNI36', 'Computers', 'Electronics', 'computers', 1),
(37, 'UNI37', 'Televisions', 'Electronics', 'televisions', 1),
(39, 'UNI39', 'Headphones', 'Electronics', 'headphones', 1);
...
(6, 'fsf345', 23, 323, '2019-01-22', '2019-01-25', 0, NULL, NULL, NULL, 0),
(7, 'DSE2345', 50, 100, '2019-01-16', '2019-01-31', 0, NULL, NULL, NULL, 0),
(8, 'DSE2346', 50, 100, '2019-01-16', '2019-01-31', 0, NULL, NULL, NULL, 0),
(9, 'GGG2345', 34, 100, '2019-01-16', '2019-01-31', 0, NULL, NULL, NULL, 0),
(10, 'GGG2346', 34, 100, '2019-01-16', '2019-01-31', 0, NULL, NULL, NULL, 0),
(11, 'GGG2347', 34, 100, '2019-01-16', '2019-01-31', 0, NULL, NULL, NULL, 0),
(12, 'GGG2348', 34, 100, '2019-01-16', '2019-01-31', 0, NULL, NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `manage_paymentgateway`
--

CREATE TABLE `manage_paymentgateway` (
...
--
-- Dumping data for table `manage_paymentgateway`
--
...
--
-- Table structure for table `manage_wallets`
--

CREATE TABLE `manage_wallets` (
  `id` int(11) NOT NULL,
  `user_id` varchar(15) NOT NULL,
...
(11, 'shoaib.kipm@gmail.com', '15912', 0);
...
CREATE TABLE `user_affiliates` (
  `aff_id` smallint(2) NOT NULL,
  `aff_level` smallint(2) NOT NULL,
...
--
-- Table structure for table `user_bidcoupon_rate`
--
...
--
-- Dumping data for table `user_bidcoupon_rate`
--
...
--
-- Table structure for table `user_bidcoupon_records`
--

CREATE TABLE `user_bidcoupon_records` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `user_bidcoupon_records`
--
...
(6, 'pankaj', 'kishor', 'kumar', 'NUdreHUwRk4rYmRUNU5xVkJyMnRzZz09', 'enjoy', 'MpbH72K3u', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(7, 'kishor', 'Kishor', 'kumar', 'SkI0VmVQUGxOdkFIa1dzaDFWNloyVGhZZ25LaE12TE01eGxEZlRZZ0tMST0=', 'enjoy', 'T1Jk6bNi9', 15, 30, 5, 0, 0, 0, NULL, '0000-00-00'),
(8, 'kishor', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'enjoyi', 'b8CpE9Xo5', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(9, 'kishor', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'en', 'Z870rIHtf', 10, 30, 4, 0, 0, 0, NULL, '0000-00-00'),
(10, 'kishor', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'enjoy', 'vpR1tQ4U3', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(11, 'fsdfs', 'dd', 'sfsfs', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'sfs', 'y4Jav35DN', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(12, 'kishor', 'John', 'Doe', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'enjoy', '87mDRqQo4', 10, 30, 4, 0, 0, 0, NULL, '0000-00-00'),
(13, 'rakesh', 'rakesh', 'kumar', 'WFg0WS9HVlhkSHZjR3RMT3Z0d1lVREpyK0c2em9KcGkrZWY5TEZGWXRQTT0=', 'enjoy', '34K2eCdSv', 15, 30, 5, 0, 0, 0, NULL, '0000-00-00'),
(14, 'kishor', 'kishor', 'Doe', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'vwe', '195EAsRxf', 10, 30, 4, 0, 0, 0, NULL, '0000-00-00'),
(15, 'kishor', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'vwe', 'iWdS9R26g', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(16, 'kishor kumr', 'Prakash', 'Kumar', 'VG42VmlJM0V1N0xpUjFqUGsyaVVLcXVGblVSQ1dLRXd5Vmx6cGM4TDZhRT0=', 'enjoy', '8zKFv5gU4', 10, 30, 4, 0, 1, 0, NULL, '0000-00-00'),
(17, 'kishor', 'Prakash', 'Kumar', 'VG42VmlJM0V1N0xpUjFqUGsyaVVLcXVGblVSQ1dLRXd5Vmx6cGM4TDZhRT0=', 'enjoy', 'vb5FJ39fH', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(18, 'kishor kumar', 'kishor', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'enjoy', '62O0hGzXa', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(19, 'Rajesh kumar', 'Rajesh', 'kumar', 'ZzZlOEE5bHk1bE81dVVSejdQRjJ2WkVBQ3RIbEhjZ1d6a053S2YzMXlKVT0=', 'ev', '1BgJ07nRi', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(20, 'Kishor Kumar', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'enjoy', 'Qa3uFB54o', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(21, 'Kishor Kumar', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'enjoy', 'p4rcV0KQ5', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(22, 'kishor', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'enjoy', '09G3mzPhI', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(23, 'kishor kumar', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'enjoy', '6O4PqfJr9', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(24, 'Rajesh kumar', 'Rajesh', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'eej', '27oV9LDrz', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(25, 'kishor', 'kishor', 'kumar', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'enju', 'j7hNZDk69', 5, 20, 3, 0, 1, 0, 'vwev', '2021-08-08'),
(26, 'kishor', 'John', 'Doe', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'enjoy', 'mT7b1UuI3', 5, 20, 3, 1, 1, 0, 'efevwe', '2021-08-10'),
(27, 'kishor kumar raj', 'kishor', 'kumar raj', 'TEFVT0JjNzZDdmFIaDRrZXNxb2J2VkpqcGYwdG4vVWE4SEVpaTdJZHo2Yz0=', 'test', 'pch2R49YH', 5, 20, 3, 1, 1, 0, '', '2021-08-13'),
(28, 'kishor', 'John', 'Doe', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'enhot', 'Oqo761HLb', 5, 20, 3, 0, 1, 0, NULL, '2021-08-13'),
(29, 'kishor kumar', 'kishor', 'kumar', 'MUdjRWxEYm85NmdXZjlwUnBpc0UyalpUQTdyWS84b250Y0t0T3RKb1YxWT0=', 'enjoy', 'nEa5w29QB', 10, 30, 4, 0, 1, 0, NULL, '2021-08-13'),
(30, 'kishor kumar raj', 'kishor', 'kumar raj', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', '', '5It49NTay', 5, 20, 3, 0, 0, 0, NULL, '0000-00-00'),
(31, 'Rajesh kumar', 'Rajesh', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'enjoy', 'TkIleF268', 10, 30, 4, 0, 0, 0, NULL, '0000-00-00'),
(32, 'kishor kumar', 'kishor', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'enjoy', 'hdP2mEF15', 10, 30, 4, 0, 0, 0, NULL, '0000-00-00'),
(33, 'kishor kumar', 'kishor', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'enjoy', '6jZ17wVaF', 10, 30, 4, 0, 0, 0, NULL, '0000-00-00'),
(34, 'kishor kumar raj', 'kishor', 'kumar raj', 'MUdjRWxEYm85NmdXZjlwUnBpc0UyalpUQTdyWS84b250Y0t0T3RKb1YxWT0=', 'test', 'vA6O3s1cU', 10, 30, 4, 0, 0, 0, NULL, '0000-00-00'),
(35, 'kishor kumar', 'kishor', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'test', '5iv0KZuW4', 15, 30, 5, 0, 0, 0, NULL, '0000-00-00'),
(36, 'kishor kumar', 'kishor', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'e', '1XKf65tuW', 15, 30, 5, 0, 1, 0, NULL, '2021-08-19'),
(37, 'kishor kumar', 'kishor', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'ber', '7QvWqS60g', 15, 30, 5, 0, 0, 0, NULL, '0000-00-00'),
(38, 'kishor kumar raj', 'kishor', 'kumar raj', 'MUdjRWxEYm85NmdXZjlwUnBpc0UyalpUQTdyWS84b250Y0t0T3RKb1YxWT0=', 'vwe', '7q1FsoR0I', 15, 30, 5, 0, 0, 0, NULL, '0000-00-00'),
(39, 'Rajesh kumar', 'Rajesh', 'kumar', 'ZzZlOEE5bHk1bE81dVVSejdQRjJ2WkVBQ3RIbEhjZ1d6a053S2YzMXlKVT0=', 'vwe', 'et9J21mEK', 10, 30, 4, 0, 1, 0, NULL, '2021-08-19'),
(40, 'Rajesh kumar', 'Rajesh', 'kumar', 'ZzZlOEE5bHk1bE81dVVSejdQRjJ2WkVBQ3RIbEhjZ1d6a053S2YzMXlKVT0=', 'er', '1k2SGa3Fp', 15, 30, 5, 0, 1, 0, NULL, '2021-08-19'),
(41, 'kishor kumar raj', 'kishor', 'kumar raj', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'ss', '5cs72ZbBC', 10, 30, 4, 0, 1, 0, NULL, '2021-08-19'),
(42, 'kishor kumar raj', 'kishor', 'kumar raj', 'MUdjRWxEYm85NmdXZjlwUnBpc0UyalpUQTdyWS84b250Y0t0T3RKb1YxWT0=', 'test', '09JFoGn7h', 10, 30, 4, 0, 0, 0, NULL, '0000-00-00'),
(43, 'kishor kumar raj', 'kishor', 'kumar raj', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'rw', 'F8R6b2eUz', 5, 20, 3, 0, 1, 0, NULL, '2021-08-23'),
(44, 'kishor kumar raj', 'kishor', 'kumar raj', 'MUdjRWxEYm85NmdXZjlwUnBpc0UyalpUQTdyWS84b250Y0t0T3RKb1YxWT0=', 'te', '1GZBvj2q6', 5, 20, 3, 0, 1, 0, NULL, '2021-08-23'),
(45, 'kishor kumar raj', 'kishor', 'kumar raj', 'MUdjRWxEYm85NmdXZjlwUnBpc0UyalpUQTdyWS84b250Y0t0T3RKb1YxWT0=', 'test', '9QLM3a4dy', 5, 20, 3, 0, 1, 0, NULL, '2021-08-23'),
(46, 'kishor kumar', 'kishor', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 've', 'X8t2kiG7M', 5, 20, 3, 0, 1, 0, NULL, '2021-08-23'),
(47, 'kishor kumar raj', 'kishor', 'kumar raj', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'bre', 'J5oZr8j1L', 5, 20, 3, 0, 1, 0, NULL, '2021-08-23'),
(48, 'kishor kumar', 'kishor', 'kumar', 'Q0pxaWgxZ3VIY1F2SFdXZ0R3dklwNEtlcDRrZGU2Uzd5bFhYTFN6K1Iraz0=', 'vweewve', '9nMC7i8kE', 5, 20, 3, 0, 1, 0, NULL, '2021-08-23'),
...
--
-- Table structure for table `user_bidcredit_rate`
--
...
--
-- Dumping data for table `user_bidcredit_rate`
--
...
CREATE TABLE `user_credits` (
  `id` int(11) NOT NULL,
  `user_id` varchar(15) NOT NULL,
  `paid_credit` smallint(10) NOT NULL,
  `free_credit` smallint(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(5, 'referral_joined', 'Your Referral Has Joined [[SITENAME]]', '<p>Hello [[USERNAME]],<br />\n<br />\nThank you for referring your friend to join [[SITENAMELINK]].</p>\n\n<p>Your friend has just registered their new account. As soon as they start to share events, you will be awarded your gift.</p>\n\n<p>Thanks again for the referral, and to earn more gift points, simply refer more friends.<br />\n<br />\nThank you,<br />\nReferral Administrator</p>\n\n<hr />\n<p>Please do not respond to this email address as it is not monitored. If you have a question, please use the contact us form at [[SITENAMELINK]].</p>\n', 1),
(6, 'auction_won', 'Auction Winner Update at [[SITENAME]]', '<div>Hello [[USERNAME]],</div>\n\n<div>&#160;</div>\n\n<div>[[IMAGE]]</div>\n\n<div>&#160;</div>\n\n<div>The auction for the [[AUCTIONNAMELINK]] at [[SITENAMELINK]] is now over.</div>\n\n<div>&#160;</div>\n\n<div>\n<div>CONGRATULATIONS, YOUR BID OF [[BIDAMOUNT]] WAS THE WINNING BID!</div>\n\n<div>&#160;</div>\n\n<div>You may view all the bids for the auction on the results page at [[SITENAMELINK]].</div>\n</div>\n\n<div>&#160;</div>\n\n<div>\n<div>Please bid on another [[SITENAMELINK]] auction for more chances to win name brand products at up to 98% off their retail value.</div>\n\n<div>&#160;</div>\n\n<div>The administration at [[SITENAMELINK]] will be contacting you shortly regarding your win. Please ensure that all the contact information you used to register your account is current.</div>\n</div>\n\n<div>&#160;</div>\n\n<div>\n<div>Thank you,</div>\n\n<div>Team [[SITENAME]]</div>\n</div>\n\n<div>&#160;</div>\n\n<div>Please do not respond to this email address as it is not monitored. If you have a question, please use the contact us form at [[SITENAMELINK]].</div>\n', 1),
...
INSERT INTO `user_payment` (`id`, `user_id`, `purchase_date`, `amount`, `txn_id`, `plan_id`, `plan_type`, `paid_amount`, `paid_credit`, `free_credit`, `paymentgateway_id`) VALUES
(1, 'UNI4-2021', '2021-08-23', '12.20', 'ch_3JRbv7SJTrSMxFdu0WqnZLM6', 25, 'credit_pay', '10.00', 20, 10, 1),
(2, 'UNI4-2021', '2021-08-23', '12.30', '0JK28644GK889970F', 25, 'credit_pay', '10.00', 20, 10, 1),
(3, 'UNI4-2021', '2021-08-23', '12.30', '5HS40522UC0353705', 25, 'credit_pay', '10.00', 20, 10, 1),
(4, 'UNI4-2021', '2021-08-24', '12.20', 'ch_3JReICSJTrSMxFdu1qDDTDfa', 25, 'credit_pay', '10.00', 20, 10, 1),
(5, 'UNI4-2021', '2021-08-24', '12.20', 'ch_3JReJPSJTrSMxFdu0pcKi2zJ', 25, 'credit_pay', '10.00', 20, 10, 1),
(6, 'UNI4-2021', '2021-08-24', '12.30', '25P57023Y66986148', 25, 'credit_pay', '10.00', 20, 10, 1),
...
--
-- Indexes for table `admin_config_app`
--
ALTER TABLE `admin_config_app`
  ADD UNIQUE KEY `id` (`id`);

--
-- Indexes for table `admin_config_points`
--
ALTER TABLE `admin_config_points`
  ADD UNIQUE KEY `id` (`id`);

--
-- Indexes for table `admin_config_social`
--
ALTER TABLE `admin_config_social`
  ADD UNIQUE KEY `id` (`id`);
...
--
-- Indexes for table `auction_features`
--
ALTER TABLE `auction_features`
  ADD PRIMARY KEY (`auction_id`),
  ADD UNIQUE KEY `auct_id` (`auct_id`);

--
-- Indexes for table `auction_invoice`
--
...
ALTER TABLE `auction_items`
  ADD PRIMARY KEY (`auction_id`),
  ADD UNIQUE KEY `Unique_Id` (`auct_id`);
...
--
-- Indexes for table `manage_coupons`
--
ALTER TABLE `manage_coupons`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`);

--
-- Indexes for table `manage_paymentgateway`
--
...
ALTER TABLE `user_affiliates`
  ADD UNIQUE KEY `aff_id` (`aff_id`);

--
-- Indexes for table `user_bidcoupon_rate`
--
ALTER TABLE `user_bidcoupon_rate`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_bidcoupon_records`
--
ALTER TABLE `user_bidcoupon_records`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_bidcredit_rate`
--
...
--
-- AUTO_INCREMENT for table `admin_config_app`
--
ALTER TABLE `admin_config_app`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `admin_config_points`
--
ALTER TABLE `admin_config_points`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `admin_config_social`
--
ALTER TABLE `admin_config_social`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
